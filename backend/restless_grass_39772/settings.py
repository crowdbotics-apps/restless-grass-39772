"""
Django settings for restless_grass_39772 project.
...
ROOT_URLCONF = 'restless_grass_39772.urls'
...
WSGI_APPLICATION = 'restless_grass_39772.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_grass_39772 API",
    "DESCRIPTION": "API documentation for restless_grass_39772 App",
    "VERSION": "v1",
}
